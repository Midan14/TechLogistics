...
import FormularioPedido from './components/FormularioPedido.jsx'; // Asegúrate de la ruta correcta
import SeguimientoEnvio from './components/SeguimientoEnvio.jsx'; // Asegúrate de la ruta correcta
...
function Home() {
    ...
    return (
        <div>
            <h1 className="text-3xl font-semibold text-center text-blue-600 mb-6">Sistema de Gestión de Pedidos y Rastreo de Envíos</h1>
            {!selectedPedido ? (
                <>
